...
public class RabbitConfig {
    ...
    public static final String RK_ATTENDANCE_FRAUD        = "attendance.fraud.detected";
    ...
    public static final String Q_ATTENDANCE_FRAUD        = "notification.attendance.fraud.detected";
    ...
    public static final String Q_PAYROLL_ANOMALY         = "notification.payroll.anomaly.detected";
    ...
    @Bean public Queue qAttendanceFraud()       { return QueueBuilder.durable(Q_ATTENDANCE_FRAUD).build(); }
    ...
    @Bean public Queue qPayrollAnomaly()        { return QueueBuilder.durable(Q_PAYROLL_ANOMALY).build(); }
    ...
    @Bean public Binding bAttendanceFraud(TopicExchange hrmsEvents)       { return BindingBuilder.bind(qAttendanceFraud()).to(hrmsEvents).with(RK_ATTENDANCE_FRAUD); }
    ...
    @Bean public Binding bPayrollAnomaly(TopicExchange hrmsEvents)        { return BindingBuilder.bind(qPayrollAnomaly()).to(hrmsEvents).with(RK_PAYROLL_ANOMALY); }

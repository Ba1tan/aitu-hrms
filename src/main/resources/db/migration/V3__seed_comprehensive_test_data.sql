...
-- Разработка
('a1000000-0000-0000-0000-000000000001', 'Senior Backend Developer',  'Java/Spring Boot',         450000, 700000, 'd1000000-0000-0000-0000-000000000001', false, NOW(), NOW(), 'system'),
('a1000000-0000-0000-0000-000000000002', 'Backend Developer',         'Java/Spring Boot',         280000, 450000, 'd1000000-0000-0000-0000-000000000001', false, NOW(), NOW(), 'system'),
('a1000000-0000-0000-0000-000000000003', 'Frontend Developer',        'React/TypeScript',         250000, 420000, 'd1000000-0000-0000-0000-000000000001', false, NOW(), NOW(), 'system'),
('a1000000-0000-0000-0000-000000000004', 'DevOps Engineer',           'Docker/K8s/CI',            350000, 550000, 'd1000000-0000-0000-0000-000000000001', false, NOW(), NOW(), 'system'),
-- HR
('a1000000-0000-0000-0000-000000000005', 'HR Manager',                'Управление персоналом',    300000, 450000, 'd1000000-0000-0000-0000-000000000002', false, NOW(), NOW(), 'system'),
('a1000000-0000-0000-0000-000000000006', 'HR Specialist',             'Рекрутинг и кадры',        180000, 300000, 'd1000000-0000-0000-0000-000000000002', false, NOW(), NOW(), 'system'),
-- Финансы
('a1000000-0000-0000-0000-000000000007', 'Chief Accountant',          'Главный бухгалтер',        400000, 550000, 'd1000000-0000-0000-0000-000000000003', false, NOW(), NOW(), 'system'),
('a1000000-0000-0000-0000-000000000008', 'Accountant',                'Бухгалтер',                220000, 350000, 'd1000000-0000-0000-0000-000000000003', false, NOW(), NOW(), 'system'),
-- Продажи
('a1000000-0000-0000-0000-000000000009', 'Sales Manager',             'Менеджер по продажам',     250000, 500000, 'd1000000-0000-0000-0000-000000000004', false, NOW(), NOW(), 'system'),
('a1000000-0000-0000-0000-000000000010', 'Sales Representative',      'Специалист по продажам',   150000, 280000, 'd1000000-0000-0000-0000-000000000004', false, NOW(), NOW(), 'system'),
-- Операции
('a1000000-0000-0000-0000-000000000011', 'Operations Manager',        'Руководитель операций',    320000, 480000, 'd1000000-0000-0000-0000-000000000005', false, NOW(), NOW(), 'system'),
-- Маркетинг
('a1000000-0000-0000-0000-000000000012', 'Marketing Specialist',      'Диджитал маркетолог',      200000, 350000, 'd1000000-0000-0000-0000-000000000006', false, NOW(), NOW(), 'system');
...
('e1000000-0000-0000-0000-000000000001', 'EMP-0001', 'Nursultan',  'Torekhanov', 'Bekovich',
 ...
 'd1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', NULL,
...
('e1000000-0000-0000-0000-000000000011', 'EMP-0011', 'Ainur',      'Zhaksylykova','Bekova',
 ...
 'd1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000005', NULL,
 true, false, false, false, NOW(), NOW(), 'system'),
...
('e1000000-0000-0000-0000-000000000012', 'EMP-0012', 'Gulnara',    'Omarova',    'Askarovna',
 ...
 'd1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000006',
...
('e1000000-0000-0000-0000-000000000016', 'EMP-0016', 'Zulfiya',    'Yessenova',  'Аскаровна',
 ...
 'd1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000007', NULL,
 true, false, false, false, NOW(), NOW(), 'system'),
...
('e1000000-0000-0000-0000-000000000021', 'EMP-0021', 'Berik',      'Seilov',     'Маратович',
 ...
 'd1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000009', NULL,
 true, false, false, false, NOW(), NOW(), 'system'),
...
('e1000000-0000-0000-0000-000000000022', 'EMP-0022', 'Asel',       'Nurova',     'Бекова',
 ...
 'd1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000010',
...
('e1000000-0000-0000-0000-000000000028', 'EMP-0028', 'Serik',      'Bekmuratov', 'Жандосович',
 ...
 'd1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000011', NULL,
 true, false, false, false, NOW(), NOW(), 'system'),
...
('e1000000-0000-0000-0000-000000000029', 'EMP-0029', 'Tolkyn',     'Abenova',    'Серікова',
 ...
 'd1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000011',
...
('e1000000-0000-0000-0000-000000000032', 'EMP-0032', 'Kamilla',    'Bekova',     'Нурлановна',
 ...
 'd1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000012', NULL,
 true, false, false, false, NOW(), NOW(), 'system'),
...
('e1000000-0000-0000-0000-000000000033', 'EMP-0033', 'Aruzhan',    'Smagulova',  'Бекова',
 ...
 'd1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000012',
